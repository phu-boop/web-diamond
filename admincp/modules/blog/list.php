                ...
                <tr>
                    ...
                    <td >
                        <div style="display: flex; justify-content: center; align-items: center;">
                            <a class="btn edit" href="?action=quanlybaiviet&&query=sua&id=<?php echo $row['id_baiviet']; ?>"><i class="fa-regular fa-pen-to-square"></i></a>
                            <a class="btn remove" name="edit" href="modules/blog/handle.php?id=<?php echo $row['id_baiviet']; ?>"><i class="fa-solid fa-trash"></i></a>
                        </div>
                    </td>
                </tr>
                <?php

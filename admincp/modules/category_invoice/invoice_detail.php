        ...
        <div class="page_detail">
                <div class="order-details">
                    ...
                    <table class="order-table">
                        ...
                        <tbody>
                        <?php $i = 0; $tongtien=0; while ($product_row = mysqli_fetch_assoc($query_list_sp)) {  $i++;$tongtien+=$product_row['soluong'] * $product_row['giasp']; ?>
                            <tr>
                                <td id="product"><img src="modules/productMNG/image_product/<?php echo $product_row['hinhanh']; ?>" alt="anh san phẩm"><span><?php echo $product_row['tensanpham']; ?></span></td>
                    ...
                    <div class="totals">
                        ...
                        ?>
                            <p><p class="title">Giảm giá:</p><span><?php echo $customer_row['giatri'];?> %</span></p>
                        <?php
                        }elseif(isset($customer_row['loai_khuyenmai'])&&$customer_row['loai_khuyenmai']=='codinh'){
                            $thanhtien=$tongtien-$customer_row['giatri'];
                        ?>
                            <p><p class="title">Giảm giá:</p><span><?php echo $customer_row['giatri'];?> VNĐ</span></p>
                        <?php
                        }else{
                        ?>
                            <p><p class="title">Giảm giá:</p><span>0 VNĐ</span></p>
                        <?php } ?>
                        <p><p class="title">Thuế:</p><span>0 VNĐ</span></p>
                        <p><p class="title">Tổng cộng:</p><span><?php

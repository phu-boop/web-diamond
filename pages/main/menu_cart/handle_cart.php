<?php
    ...
    // Tạo giỏ hàng mới
    $sql = "INSERT INTO tbl_giohang(id_khachhang, ma_giohang, trangthai_giohang, id_khuyenmai, ngay_mua, pt_thanhtoan, id_vanchuyen) 
            VALUES ('$id_customer', '$code_cart', '1', '$id_khuyenmai',NOW(),'$thanhtoan','$id_vanchuyen')";
